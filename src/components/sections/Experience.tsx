...
function ExperienceTile({ item }: { item: ExperienceItem }) {
  return (
    <motion.div
      variants={fadeInUp}
    ...
    <section id="experience" className="py-24 bg-muted/30">
      <div className="section-container">
        ...
        {education.length > 0 && (
          ...
          >
            <h3 className="text-[3.5rem] font-bold text-foreground mb-8">Education</h3>

            {/* Timeline line */}
            <div className="absolute left-[22px] top-[68px] bottom-0 w-px bg-card-border hidden md:block" />
